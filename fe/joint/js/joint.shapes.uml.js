...
joint.shapes.uml.Class = joint.shapes.basic.Generic.extend({
    ...
    markup: [
        '<g class="rotatable">',
          '<g class="scalable">',
            '<rect onclick="top.changerect(evt)" class="uml-class-name-rect"/><rect class="uml-class-attrs-rect" /><rect class="uml-class-methods-rect"/>',
          '</g>',
...
joint.shapes.uml.Transition = joint.dia.Link.extend({
    defaults: {
        ...
        attrs: {
            ...
            '.connection': { stroke: '#2c3e50', 'stroke-width': 3},
        },
        labels: [
            { position: 25, attrs: { text: { text: '1..n' } }},
            { position: -25, attrs: { text: { text: 'bldux' } }},
        ]
    },
});
